...
urlpatterns = [
    ...
    path('password_reset/done/', PasswordResetDoneView.as_view(template_name='acc/password_reset_done.html'), name='password_reset_done'),
    ...
    path('profile_pictures/',UpdateProfile.as_view(), name='profile_picture')
